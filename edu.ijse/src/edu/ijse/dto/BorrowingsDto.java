...
public class BorrowingsDto {
    ...
    public BorrowingsDto(String borrowindId, String memberId, String bookId, String borrowDate, String dueDate) {
    ...
    public String toString() {
        return "BorrowingDto{" + "borrowindId=" + borrowindId + ", memberId=" + memberId + ", bookId=" + bookId + ", borrowDate=" + borrowDate + ", dueDate=" + dueDate + '}';
    }
